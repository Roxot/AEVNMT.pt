...
class SenVAE(nn.Module):
    ...
    def loss(self, lm_likelihood: Categorical, targets_x, qz: Distribution,
            free_nats=0., KL_weight=1., mmd_weight=0., smoothing_x=0., smoothing_y=0., reduction="mean", aux_lm_likelihoods=dict(), loss_cfg=set()):
        """
        ...
        if not self.mixture_likelihood:
            ...
            aux_log_likelihood = side_lm_likelihood.sum(0)
